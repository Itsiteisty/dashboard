...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $ip = $_SERVER['REMOTE_ADDR'] ?? 'IP não encontrado';
    ...
    // Log no terminal da Render
    error_log("Nova submissão de formulário:");
    error_log("IP: $ip");
    error_log("Nome: $name");
    error_log("Discord: $discord");
    error_log("Resultado do insert: " . ($result['success'] ? "Sucesso" : "Falha"));
...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="">
            ...
            <label>Discord Tag (e.g., User#1234):</label>
